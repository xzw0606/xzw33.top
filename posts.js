const POSTS = [
    ...
    module: "strategy",
    title: "策略更新 v3.9 — # VERSION: 2026-06-17 v3.9.50 — 方案C: ATR追踪止损 + EMA",
    date: "2026-06-17",
    tags: ["策略更新", "v3.9"],
    summary: "# VERSION: 2026-06-17 v3.9.50 — 方案C: ATR追踪止损 + EMA死叉止盈",
    content: '<h2>策略版本 v3.9 (2026-06-17)</h2>'+
      '<h3>核心更新</h3>'+
      '<p>VERSION: 2026-06-17 v3.9.50 — 方案C: ATR追踪止损 + EMA死叉止盈</p>'+
      '<h3>文件变更</h3>'+
      '<ul><li><code>config.py</code></li></ul>'+
      '<hr>'+
      '<blockquote>策略持续迭代中，每周更新记录。</blockquote>'
  },
  {
    id: "strategy-update-20260605-v39",
    module: "strategy",
    title: "策略更新 v3.9 — # VERSION: 2026-06-05 v3.9.48 — 手动仓位不接管止损 — EMA缓冲0",
    date: "2026-06-05",
    tags: ["策略更新", "v3.9"],
    summary: "# VERSION: 2026-06-05 v3.9.48 — 手动仓位不接管止损 — EMA缓冲0.2%+冷却30min — TP1/SL1出场",
    content: '<h2>策略版本 v3.9 (2026-06-05)</h2>'+
      '<h3>核心更新</h3>'+
      '<p>VERSION: 2026-06-05 v3.9.48 — 手动仓位不接管止损 — EMA缓冲0.2%+冷却30min — TP1/SL1出场</p>'+
      '<h3>文件变更</h3>'+
      '<ul><li><code>config.py</code></li></ul>'+
      '<hr>'+
      '<blockquote>策略持续迭代中，每周更新记录。</blockquote>'
  },
  {
    ...
    module: "strategy",
    title: "策略更新 v3.9 — 持仓管理模块 - 单仓版本 VERSION: 2026-05-31 v3.9.31",
    date: "2026-05-31",
    tags: ["策略更新", "v3.9"],
    summary: "持仓管理模块 - 单仓版本 VERSION: 2026-05-31 v3.9.31",
    content: '<h2>策略版本 v3.9 (2026-05-31)</h2>'+
      '<h3>核心更新</h3>'+
      '<p>持仓管理模块 - 单仓版本 VERSION: 2026-05-31 v3.9.31</p>'+
      '<h3>文件变更</h3>'+
      '<ul><li><code>manager.py</code></li></ul>'+
      '<hr>'+
      '<blockquote>策略持续迭代中，每周更新记录。</blockquote>'
  },
// ===== 量化交易笔记（真实内容）=====
